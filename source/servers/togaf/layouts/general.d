...
class DTGFGeneralLayout : DMVCLayout {
  ...
  mixin(OProperty!("DH5Obj", "TGFPageHeader"));
  mixin(OProperty!("DH5Obj", "TGFPageBody"));
  mixin(OProperty!("DH5Obj", "TGFFooter"));
  mixin(OProperty!("DH5Obj", "TGFSecondNavbar"));
  mixin(OProperty!("DH5Obj", "TGFNavbar"));
